...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image: "https://media.licdn.com/dms/image/v2/D5603AQFD4fvbDiUngw/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1678057916028?e=1754524800&v=beta&t=5pMkgnMwWAQxXWA2Q-gftvfJi4wRrmCw3r4UC0OHwaw",
      rating: 5,
      text: "Himanshu stood out for his strong grasp of project management concepts and his ability to bridge theory with practical insight. He consistently brought professionalism, analytical thinking, and a collaborative spirit to every class project.",
      linkedinUrl: "https://www.linkedin.com/in/nikhil247gulati/",
      projectType: "Peer Learning",
    },
    {
      name: "Asraa Ahmad, PMP®",
      role: "Project Management Instructor",
      company: "Fleming College",
      image: "https://media.licdn.com/dms/image/v2/D4E03AQFxmA6sDKC63Q/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1726610847831?e=1754524800&v=beta&t=5cTaV3twBMRcvyhIZfj5ej6P-x-zOgscxAmxKQGcSAQ",
      rating: 5,
      text: "I was continually impressed by Himanshu’s ability to think critically and apply project management principles with precision. His leadership, communication skills, and commitment to excellence set him apart in both individual and group work.",
      linkedinUrl: "https://www.linkedin.com/in/ahmadasraa/",
      projectType: "Peer Learning",
    },
  ]
